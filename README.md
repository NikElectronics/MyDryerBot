# TempBot-1000 - Интеллектуальная сушилка для филамента

[🚀 Открыть  инструкцию TempBot-1000](https://nikelectronics.github.io/TempBot-1000/)


## 🚀 О проекте

**TempBot-1000** - это продвинутая система для нагрева и поддержания оптимальной влажности  с интеллектуальным управлением через веб-интерфейс. Проект сочетает в себе современные технологии PID-регулирования, Wi-Fi управление и удобный пользовательский интерфейс.
